...
module.exports.factory = function(apiwrapper, config){
  ...
  supplier_warehouse.use('/select', function(packet, next){
    ...
    packet.filter(function(body){
      ...
      return _.map(body, function(raw_container){
        ...
        raw_container._meta.protocol = supplier_warehouse.protocol();
        raw_container._meta.hostname = supplier_warehouse.hostname();
