...
Warehouse.prototype.ready = function(fn){
...
Warehouse.prototype.automount = function(middleware){
  middleware && this.use(middleware);
}

Warehouse.prototype.setup = function(){
  
}

Warehouse.prototype.boot = function(){
