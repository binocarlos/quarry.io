...
System.prototype.initialize = function(layout, deployment){
  ...
  /*
    ...
    the supply chain onto the system database
  ...
  */
  ...
  /*
    ...
    the portal onto the system switchboard
...
*/
System.prototype.bind = function(callback){
...
System.prototype.upload = function(layout, callback){
  ...
  SupplyChain('system', '/database').connect(function(db){
    ...
    log.info('appending system data');
    ...
    */
    ...
    db.append(layout).ship(function(){
      ...
      self.stacks = layout.find('stacks');
      self.infrastructure = layout.find('infrastructure');
...
/*
  ...
  upload a stack's layout and load the database stack container
  
*/
System.prototype.upload_stack = function(stack, callback){
  var self = this;
  
  self.stacks.append(stack.root).ship(function(){
    console.log('-------------------------------------------');
    console.log('uploaded stack!');
...
/*
  ...
  we proxy to system portal off to the deployment so it can decide what to do
  
*/
System.prototype.portal_handler = function(){
