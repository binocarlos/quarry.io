...
System.prototype.upload_database = function(layout, callback){
  ...
  SupplyChain('system', '/database').connect(function(db){
    ...
    portal.listen(function(message,data){
    ...
    db.append(layout).ship(function(){
      ...
      db('instance').ship(function(instances){

        console.log('-------------------------------------------');
        console.log('instances loaded: ' + instances.count());
        ...
        instances.attr({
          ...
          db('stack').ship(function(stack){
            stack.delete().ship(function(){
              console.log('-------------------------------------------');
