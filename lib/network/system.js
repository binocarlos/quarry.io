...
System.prototype.get_layout = function(){
  ...
  */
  layout.append([this.infrastructure.get_layout(self.options), this.stackcontainer.get_layout(self.options)]);
  ...
  async.series([
    ...
    */
    function(next){
      ...
      self.switchboard = Device('switchboard.server', {
        ...
        endpoints:self.options.database.endpoints
      })
    ...
    */
    function(next){
      ...
      self.server = Device('supplychain.server', self.options.database);
    ...
    */
    function(next){
      ...
      self.client = Device('supplychain.client', self.options.database);
    ...
    function(next){
      ...
      self.stackcontainer.deploy_workers(self.infrastructure, next);
    }
