  ...
  var holdingbay = {
    ...
    */
    ...
    handlecontract:function(header, packet, callback){
      var req = JSON.parse(packet.toString());
    },
    ...
    */
    handlefront:function(frames){
      ...
      */
      ...
      this.handlepacket(header, packet, function(error, results){
        self.emit('dispatch:front', [socketid, rpcid, JSON.stringify({test:'this is the response header'}), JSON.stringify(results)]);
      })
