    ...
    */
    resolve:function(req, res, next){
      ...
      this.handlerequest(header, requeststring, function(error, responsepacket){
        ...
        res.fill(JSON.parse(responsepacket.toString()));

        res.recurse(function(checkres){
          var branches = checkres.getHeader('x-json-branches');
          if(!branches){
            return;
          }
          ...
          console.log('-------------------------------------------');
          console.log('-------------------------------------------');
          console.log('found branch in response!!!!');
        })
