...
*/
Stack.prototype.deploy_workers = function(instances, callback){

  var self = this;

  var allocationtypes = ['reception', 'api', 'web'];
  ...
  async.series([
    ...
    */
    function(next){
      async.forEachSeries(allocationtypes, function(type, next){

        self.create_worker(type, instances[type], next);
