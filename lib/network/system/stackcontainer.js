...
StackContainer.prototype.initialize = function(options){
  var self = this;
  options || (options = {});
  options.stackcontainer || (options.stackcontainer = {});
  this.options = options;
  this.stacks = [];
  this.localfolders = this.options.stackcontainer.localfolders || [];
}
...
StackContainer.prototype.get_layout = function(){
  ...
  var layout = Container.new('stacks', this.options.stackcontainer);
...
StackContainer.prototype.buildworkers = function(infrastructure, callback){
  ...
  async.forEach(self.stacks, function(stack, next_stack){
    ...
    */
    infrastructure.allocatestack(stack, function(error, allocation){
      stack.buildworkers(allocation, next_stack);
    })
