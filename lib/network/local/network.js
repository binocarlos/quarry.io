...
var LocalNetwork = module.exports = Base.extend({
  ...
  ensure_folders:function(){
    ...
    /*
      ...
      clear out the build folder each time
      
    */
    wrench.rmdirSyncRecursive(this.get('folder')+'/build', true);
  ...
  */
  ...
  post_booted:function(callback){
    ...
    fs.writeFileSync(this.get('folder') + '/build/mongroup.conf', mongrouptext, 'utf8');
