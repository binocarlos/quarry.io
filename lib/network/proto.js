...
Network.prototype.initialize = function(options, callback){
  ...
  */
  ...
  /*
    ...
    this must be set from the 'infrastructure method'
    
  */
  this.infrastructure_flavour = null;
...
Network.prototype.flavour = function(flavour){
  ...
  flavour && (self.infrastructure_flavour = flavour);
...
Network.prototype.boot = function(fn){
  ...
  if(!this.infrastructure_flavour){
  ...
  async.series([
    ...
    */
    ...
    function(next){
      log.info('preparing the infrastructure');

      self.infrastructure = Infrastructure(self.infrastructure_flavour);
    ...
    */
    ...
    function(next){
      ...
      */
      self.system = new System(self.infrastructure, self.options);
      self.system.prepare(next);
      
    },

    /*
    
      upload the system database and user stacks
    ...
    */
    ...
    function(next){
      ...
      self.system.upload(self.slurpedstacks, next);
