  ...
  warehouse:function(hostname, callback){
    ...
    */
    if(mode=='server'){
      ...
      get_supply_chain = function(){
        return client.rpc('/');
      }

      get_switchboard = function(){
    ...
    */
      ...
      var router = client.router(hostname);
      ...
      get_switchboard = function(){
        return router.switchboard;
      }
    }
    
    
    var supply_chain = get_supply_chain();
    var switchboard = get_switchboard();
