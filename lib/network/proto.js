  ...
  async.series([
    ...
    */
    function(next){
      ...
      var stacks = self.layout.find('stacks');
      ...
      */
      async.forEach(self.slurpedstacks, function(stackfolder, next_folder){
        log.info('loading stack: ' + dye.green(stackfolder));
    ...
    */
    ...
    function(next){
      ...
      self.system.upload_database(self.layout, next);
    ...
    */
    ...
    function(next){
      ...
      */
      ...
      db('instance').ship(function(){
        console.log('-------------------------------------------');
        eyes.inspect(this.toJSON());
        process.exit();
        this.each(function(stack){
          self.deployment.registerstack(stack);
        })
      })
    }
