...
module.exports = {
  ...
  */
  ...
  workerendpoint:function(worker, name){
  ...
  get_reception_endpoints:function(worker){

    return {
      front:{
        rpc:this.workerendpoint(worker, 'front.rpc')
      },
      switchboard:{
        pub:this.workerendpoint(worker, 'switchboard.pub'),
        sub:this.workerendpoint(worker, 'switchboard.sub')
      },
      back:{
        rpc:this.workerendpoint(worker, 'back.rpc')
      }
    }
  ...
  */
  get_stack_instances:function(stack, callback){

    log.info('allocating');

    return this.db.find('#localhost');
  },
