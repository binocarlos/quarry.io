...
StackContainer.prototype.allocateinstances = function(infrastructure, callback){
  ...
  async.forEach(self.stacks, function(stack, next_stack){
    ...
    infrastructure.getstackinstances(stack, function(error, instances){
      log.info('loaded : ' + dye.green(instances.count()) + ' instances');
      next_stack();
    })
