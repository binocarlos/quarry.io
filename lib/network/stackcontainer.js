...
function StackContainer(infrastructure){
  EventEmitter.call(this);
  this.initialize(infrastructure);
}
...
*/
StackContainer.prototype.initialize = function(infrastructure){
  var self = this;
...
StackContainer.prototype.get_layout = function(){
  ...
  var layout = Container.new('stacks');
...
StackContainer.prototype.build_stack = function(folder){
  ...
  stack.on('deploy_worker', function(worker, callback){
    self.infrastructure.deploy_worker(stack, worker, callback);
  })
...
*/
StackContainer.prototype.slurpstacks = function(rawstacks, callback){
...
StackContainer.prototype.allocate = function(infrastructure, callback){
  ...
  async.forEach(self.stacks, function(stack, next_stack){
    ...
    */
    infrastructure.allocate_instances(stack, function(error, allocation){
