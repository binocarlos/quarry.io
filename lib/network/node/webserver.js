...
var ReceptionFront = require('./client/receptionfront');
...
WebServer.prototype.boot = function(callback){
  ...
  async.series([
    ...
    */
    ...
    function(next){
      var serveroptions = _.clone(self.node.attr());
      serveroptions.supplychain = self.supplychain;
      serveroptions.endpoint = self.spark.attr('endpoints').http;
      serveroptions.worker = worker;
      
      self.server = Server(serveroptions);
