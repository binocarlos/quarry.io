...
/*
  ...
  return an augmented switchboard implementation that adds the hostname
  into the channel invisibly
  
*/
PubSubClient.prototype.wrapper = function(hostname){
  var self = this;
  var ret = {};
  _.each(['listen', 'broadcast', 'remove', 'removeAll'], function(method){
    ret[method] = function(){
      var args = _.toArray(arguments);
      var channel = args[0];
      args[0] = hostname + ':' + channel;
