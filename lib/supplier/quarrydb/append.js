...
function cascadeInsert(mongoclient, data, parent_data, runportal, finishedcallback){
  ...
  if(!parent_data){
    ...
    getNextRootPosition(mongoclient, function(error, next_root_position){
      ...
      saveContainer(mongoclient, data, function(error){
        ...
        runportal(parent_data, data);

        async.forEach(data.children || [], function(child_data, next_child){
          cascadeInsert(mongoclient, child_data, data, runportal, next_child);
        }, function(error){
    ...
    function run_append(parent_data){
      ...
      */
      async.forEachSeries(data_array, function(data, next_data){
        ...
        function runportal(parent_container, child_container){

          portal(parent_container ? parent_container.meta : null, 'append', child_container);

        }
        
        cascadeInsert(mongoclient, data, parent_data ? parent_data : null, runportal, function(error){
