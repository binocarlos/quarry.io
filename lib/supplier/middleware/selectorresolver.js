...
function factory(api){
  ...
  if(!api.select){
    throw new Error('Select resolver requires a select method in the API');
  }
  ...
  return function(req, res, next){
    ...
    var skeleton_array = req.getHeader('x-json-skeleton-array');
    ...
    */
    async.forEachSeries(strings.reverse(), function(stage, next_string){
      ...
      async.forEach(stage, function(phase, next_phase){
          ...
          */
          ...
          api.select({
            ...
            */
              ...
              phase_results = phase_results.concat(results);
            }
        ...
        */
        ...
        if(!final_state.finished){
          skeleton_array = _.map(phase_results, extractskeleton);
        }
        else{
          final_results = phase_results;
        }
