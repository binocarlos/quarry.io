...
function factory(data, supply_chain){
  ...
  */
  ...
  // normal is just to return the attribute
  ...
  // normal is just to write the value 
  ...
  container.bind_dom = function(elem, options){
    ...
    datasource || (datasource = standard_datasource(field));
