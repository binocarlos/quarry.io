...
var log = require('logule').init(module, 'Contract');
...
function Contract(data){
  ...
  this.setHeader('x-quarry-contractid', utils.quarryid());
  this.setType('merge');
  this.method = 'post';
  this.body = [];
}
...
Contract.prototype.ship = function(fn){
  var self = this;
  log.info('shipping quarry contract: ' + this.getHeader('x-contract-type') + ' : ' + this.body.length + ' requests');
