...
/*
  ...
  class level method because the reception dosn't want to have to JSON.parse a request to route by this
  
*/
module.exports.getcontractheader = function(req){
  return JSON.stringify({
    contractid:req.getHeader('x-contract-id'),
