    ...
    if(mainres.multipart()){
      ...
      _.each(mainres.multipartResponses(), function(multires){
        ...
        if(multires.skeletonid()){
          var index_container = self.container.byid(multires.skeletonid());
        ...
        /*
          ...
          the special case when we are appending to the top
          
        */
        else if(self.container.quarryid()=='warehouse'){

          var index_container = self.container.eq(0);
