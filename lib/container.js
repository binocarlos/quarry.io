...
function factory(data){
  ...
  // this is a hack - I want a proper JavaScript programmer to sort
  // out the prototype properly so I can call .prototype.find
  var functionCache = {
    find:container.find
  }

  // proxy for the underscore functional find
  // if you pass a string it means a selector
  ...
  // tells you if this container matches the given selector (NOTE not phase or contract)
  container.search = function(selector){
