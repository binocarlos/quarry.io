  ...
  function container(selector, context){
    ...
    return promiseFactory(function(promise_options, return_callback){
      ...
      supply_chain({
        action:'select',
        message:{
          // the starting point for the selector
...
proto.child_route = function(){
  return this.meta('route');
}
/*
 * Loading
 ****************************************************************
...
proto.find = function(selector_string){
  return factory(this.find_raw(selector_string), supply_chain);
}
