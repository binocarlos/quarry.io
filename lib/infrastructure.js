...
var Proto = require('./network/infrastructure');

module.exports = factory;

var flavour = {
  development:require('./network/infrastructure/development'),
  local:require('./network/infrastructure/local'),
  cloud:require('./network/infrastructure/cloud')
}
