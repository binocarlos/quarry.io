...
function factory(options){
  ...
  options = _.defaults(options, {
    ...
    views:__dirname + '/express/views',
    favicon:__dirname + '/express/resources/favicon.ico'
    

  });

  var auth_options = null;
  ...
  function build_server(){
    ...
    app.configure(function(){
      ...
      console.log(options.document_root);
    });
    ...
    if(options.auth){
      ...
      var user_warehouse = options.auth.warehouse;
      ...
      _.each(options.auth.providers, function(config, provider_name){
        console.log('-------------------------------------------');
        console.log('-------------------------------------------');
        ...
        var connect_insert_callback = function(req, res){
          ...
          auth_client.connect_insert(req.user, req.account, function(){
            res.session.save();
            res.redirect('/');
          })
  ...
  var quarry_server = {
    ...
    build:function(callback){
      ...
      stack.use = function(chain){
        this.warehouse = chain;
        return this;
      }
