...
Portal.prototype.listen = function(){
  if(this.switchboard){
    this.switchboard.listen.apply(this.switchboard, _.toArray(arguments));
  }
  return this;
}
...
Portal.prototype.post = function(selector, callback){

  var route = this.router.deepmethod('post');

  this.listen(route, function(message){
