...
Container.append = function(append_containers){
  ...
  this.models.each(function(parent_model){
    parent_model.append(children_models);
    
    transaction_rollbacks.push(function(){
      parent_model.remove(children_models);
    })
  })
