...
function wrapper(key, options){
  ...
  return function(){
    ...
    */
      ...
      valuesetter(this.models, [fullkey, arguments[0]].join('.'), arguments[0]);
      return self;
    }
  }
...
*/
Container.prototype.portal = function(deep){

  var portal = new Portal(deep);

  if(this.models.length>0 && this.supplychain){
    portal.attach(this.skeleton(), this.supplychain.switchboard);
    portal.spawn = _.bind(this.spawn, this);
  }
