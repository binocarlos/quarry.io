...
function router(skeleton){
  ...
  return {
    rpc:utils.makeroute([skeleton.quarrysupplier, info.containerpath]),
    shallow:utils.makeroute([skeleton.quarrysupplier, info.containerpath], '.'),
    deep:utils.makeroute([skeleton.quarrysupplier].concat(info.containerpath || []), '.')
  }
}