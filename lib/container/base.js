...
module.exports = BackboneDeep.extend({
  ...
  issaved:function(){
    return this.has('meta.quarryid') && this.get('meta.quarryid').match(/-/);
  },
  ...
  url:function(below){
    return route.url(this.route(below));
  }
})