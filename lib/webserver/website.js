  ...
  async.series([
    ...
    */
    ...
    function(next){
      ...
      async.forEachSeries(self.options.middleware || [], function(service, nextmiddleware){
        ...
        */
          ...
          module = module.replace(/^quarry\./, '');
          var loadedmodule = middleware[module];
    ...
    /*
      ...
      now the middleware has configured the server - we can mount core routes
      
    */
    function(next){
      log.info('setting doc root: ' + dye.yellow(self.document_root()));
