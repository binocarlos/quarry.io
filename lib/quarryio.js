...
// supply chain constructor
exports.supply_chain = function(name, options){
  if(!options){
    options = name;
    name = options.supply_chain;
  }

  return exports.supplier[name] ? exports.supplier[name](options) : exports.supplier.ram(options);
}
