...
// alias
exports.new = exports.container;


/*
  mount quarry.io on an express application
 */
exports.mount = require('./web').listen;

/*
  create quarry.io express application
 */
exports.server = require('./web').build;
