...
/**
	 ...
	 */
var get_parsed_encodings = function(data){
...
/**
	 ...
	 */
var inverse_fraction = function(data){
...
/**
	 ...
	 */
var reduce_continued_fraction_step = function(data){		
...
var calculate_encoding_from_tree_position = function(position_array, callback){
...
var encode = function(position_array, callback){

	if(!_.isArray(position_array) || position_array.length<=0){
		throw new Error('Array of tree positions required in Jquarry_Storage_Treeencoder_Rationalnestedset::calculate_encodings_from_tree_position');
	}	
